...
library(datapasta) #copy/paste data into R environment
...
Txi_gene <- tximport(path, #path was assigned above
                     type = "kallisto", 
                     tx2gene = Tx, #tells where to get gene info 
                     txOut = FALSE, #False: gene level data not transcript level 
                     countsFromAbundance = "lengthScaledTPM",
                     ignoreTxVersion = TRUE) # ignore all the .1/.2 after the id#
beep(sound = 6)
